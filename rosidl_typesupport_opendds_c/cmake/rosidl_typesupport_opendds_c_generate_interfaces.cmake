...
set(_output_path
  "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_opendds_c/${PROJECT_NAME}")
set(_dds_output_path "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_opendds_cpp/${PROJECT_NAME}")
...
if(NOT WIN32)
  ...
  if(NOT _opendds_compile_flags STREQUAL "")
    string(REPLACE ";" " " _opendds_compile_flags "${_opendds_compile_flags}")
    foreach(_gen_file ${_generated_external_files})
      set_source_files_properties("${_gen_file}"
        PROPERTIES COMPILE_FLAGS "${_opendds_compile_flags}")
    endforeach()
  endif()
endif()
...
set(target_dependencies
  ...
  "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}/idl__rosidl_typesupport_opendds_c.h.em"
  "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}/idl__dds_opendds__type_support_c.cpp.em"
  "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}/msg__rosidl_typesupport_opendds_c.h.em"
  "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}/msg__type_support_c.cpp.em"
  "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}/srv__rosidl_typesupport_opendds_c.h.em"
  "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}/srv__type_support_c.cpp.em"
...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_opendds_c__arguments.json")
rosidl_write_generator_arguments(
  ...
  TEMPLATE_DIR "${rosidl_typesupport_opendds_c_TEMPLATE_DIR}"
...
add_custom_command(
  ...
  COMMAND ${PYTHON_EXECUTABLE} ${rosidl_typesupport_opendds_c_BIN}
  --generator-arguments-file "${generator_arguments_file}"
  DEPENDS
    ${target_dependencies}
    ${_generated_external_files}
    ${_dds_idl_files}
  COMMENT "Generating C type support for OpenDDS"
  VERBATIM
)
...
foreach(_pkg_name ${rosidl_generate_interfaces_DEPENDENCY_PACKAGE_NAMES})
  ...
  set(_action_include_dir "${${_pkg_name}_DIR}/../../../include/${_pkg_name}/action/dds_opendds_c")
...
target_link_libraries(${rosidl_generate_interfaces_TARGET}${_target_suffix}
  ...
  ${rosidl_generate_interfaces_TARGET}__rosidl_typesupport_opendds_cpp)
...
if(BUILD_TESTING AND rosidl_generate_interfaces_ADD_LINTER_TESTS)
  if(NOT _generated_files STREQUAL "")
    ...
    ament_cppcheck(
      TESTNAME "cppcheck_rosidl_typesupport_opendds_c"
      ${_generated_files})

    find_package(ament_cmake_cpplint REQUIRED)
    get_filename_component(_cpplint_root "${_output_path}" DIRECTORY)
    ament_cpplint(
      TESTNAME "cpplint_rosidl_typesupport_opendds_c"
    ...
    ament_uncrustify(
      TESTNAME "uncrustify_rosidl_typesupport_opendds_c"
      # the generated code might contain longer lines for templated types
