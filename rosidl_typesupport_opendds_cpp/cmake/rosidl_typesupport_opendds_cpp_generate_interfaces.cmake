...
set(target_dependencies
  ...
  "${rosidl_typesupport_opendds_cpp_TEMPLATE_DIR}/srv__type_support.cpp.em"
...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_opendds_cpp__arguments.json")
rosidl_write_generator_arguments(
  ...
  TEMPLATE_DIR "${rosidl_typesupport_opendds_cpp_TEMPLATE_DIR}"
  TARGET_DEPENDENCIES ${target_dependencies}
  ADDITIONAL_FILES ${_dds_idl_files}
)

set(_idl_pp "$ENV{DDS_ROOT}/bin/opendds_idl")
add_custom_command(
...
"${_output_path}/msg/rosidl_typesupport_opendds_cpp__visibility_control.h")
string(TOUPPER "${PROJECT_NAME}" PROJECT_NAME_UPPER)
configure_file(
  "${rosidl_typesupport_opendds_cpp_TEMPLATE_DIR}/rosidl_typesupport_opendds_cpp__visibility_control.h.in"
...
if(BUILD_TESTING AND rosidl_generate_interfaces_ADD_LINTER_TESTS)
  if(NOT _generated_files STREQUAL "")
    ...
    ament_cppcheck(
      TESTNAME "cppcheck_rosidl_typesupport_opendds_cpp"
      ${_generated_files})

    find_package(ament_cmake_cpplint REQUIRED)
    get_filename_component(_cpplint_root "${_output_path}" DIRECTORY)
    ament_cpplint(
      TESTNAME "cpplint_rosidl_typesupport_opendds_cpp"
    ...
    ament_uncrustify(
      TESTNAME "uncrustify_rosidl_typesupport_opendds_cpp"
      # the generated code might contain longer lines for templated types
